...
/**
 * 상담신청 폼 (홈 하단 · /contact 공용). 원본 sec_contact 마크업/필드 구성 그대로.
...
export default function ContactSection({ sub = false }: { sub?: boolean }) {
  ...
  useEffect(() => { if (state && !state.ok && state.message) alert(state.message); }, [state]);
            ...
            <form action={action}>
              ...
              <div className="bottom">
                <div className="privacy">
                  <input id="agree" name="agree" type="checkbox" /><label htmlFor="agree">개인정보처리방침에 동의합니다.</label>
